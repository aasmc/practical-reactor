...
public class c4_LifecycleHooks extends LifecycleHooksBase {
    ...
    /**
     * There is advanced operator, typically used for monitoring of a Flux.
     * This operator will add behavior
     * (side-effects) triggered for each signal that happens on Flux.
     * It also has access to the context, which might be
     * useful later.
     * <p>
     * In this exercise, Flux will emit three elements and then complete.
     * Add signal names to `signal` list dynamically,
